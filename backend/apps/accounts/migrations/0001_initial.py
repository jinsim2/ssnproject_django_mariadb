    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('general', '일반 회원'), ('instructor', '강사'), ('institution_staff', '기관 담당자'), ('foreign', '외국인')], db_index=True, max_length=50)),
                ...
                ('biz_reg_no', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('company_zipcode', models.CharField(blank=True, max_length=10, null=True)),
                ...
                ('affiliation_council', models.IntegerField(blank=True, null=True)),
                ('care_bank_inst', models.IntegerField(blank=True, null=True)),
